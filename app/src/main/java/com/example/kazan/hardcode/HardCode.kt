...
val manList = listOf(
    Man("Человек №1", "1", "Какие-то теги", "Инвестор"),
    Man("Человек №2", "1", "Какие-то теги", "Инвестор"),
    Man("Человек №3", "1", "Какие-то теги", "Инвестор"),
    Man("Человек №4", "1", "Какие-то теги", "Специалист"),
    Man("Человек №5", "1", "Какие-то теги", "Специалист"),
    Man("Человек №6", "1", "Какие-то теги", "Специалист"),
    Man("Человек №7", "1", "Какие-то теги", "Инвестор"),
    Man("Человек №8", "1", "Какие-то теги", "Инвестор"),
    Man("Человек №9", "1", "Какие-то теги", "Специалист"),
    Man("Человек №10", "1", "Какие-то теги", "Специалист"),
    Man("Человек №11", "1", "Какие-то теги", "Специалист"),
    Man("Человек №12", "1", "Какие-то теги", "Инвестор"),
    Man("Человек №13", "1", "Какие-то теги", "Инвестор"),
)